...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("furniturepage:category", kwargs={
            'slug': self.slug
        })
...
class Item(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("furniturepage:product", kwargs={
            'slug': self.slug
        })

    def get_add_to_cart_url(self):
        return reverse("furniturepage:add-to-cart", kwargs={
            'slug': self.slug
        })

    def get_remove_from_cart_url(self):
        return reverse("furniturepage:remove-from-cart", kwargs={
            'slug': self.slug
        })
